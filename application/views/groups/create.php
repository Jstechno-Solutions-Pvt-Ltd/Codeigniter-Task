                ...
                <div class="form-group">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Reports</td>
                        <td><div class="custom-control custom-switch"><input type="checkbox" name="permission[]" class="custom-control-input" id="customSwitch9" value="viewThretend"><label class="custom-control-label" for="customSwitch9">&nbsp;</label></div></td>
                      </tr>
