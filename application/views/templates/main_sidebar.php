  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url('dashboard'); ?>" class="brand-link">
      <img src="<?php echo base_url('assets/AdminLTE-3.0.2/'); ?>dist/img/AdminLTELogo.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <?php if ($user_permission) {
            ...
            <?php }
            if (in_array('viewThreatend', $user_permission)) { ?>
              <li class="nav-item has-treeview" id="li-groups">
                  <a href="#" class="nav-link" id="link-groups">
                    <i class="nav-icon fas fa-users"></i>
                    <p>
                  ...
                  <ul class="nav nav-treeview">
                    <?php if (in_array('viewThreatend', $user_permission)) { ?>
                      <li class="nav-item">
                        <a href="<?php echo base_url('reports/threatend'); ?>" class="nav-link" id="rhreatend">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Threatend</p>
                        </a>
                      </li>
